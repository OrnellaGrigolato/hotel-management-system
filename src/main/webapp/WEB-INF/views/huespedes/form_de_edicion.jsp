...
<body>
            ...
            <form method="post" action="${mvc.uri('editarHuesped')}" id="editForm">
                ...
                <div class="form-grid">
                    <div class="form-group">
                        ...
                        >
                        <span class="input-hint">Nombre y apellido completo del huésped</span>
                    </div>
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group">
                            ...
                            >
                            <span class="input-hint">Número de teléfono con código de área</span>
                        </div>
                    </div>
                </div>
    ...
    <script>
        ...
        document.getElementById('nombre').addEventListener('input', checkForChanges);
        document.getElementById('documento').addEventListener('input', checkForChanges);
        document.getElementById('telefono').addEventListener('input', checkForChanges);
